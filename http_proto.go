...
func errCHTTPACT(s string) error {
	switch s {
	case "220":
		return errors.New(ERR_220)
	case "221":
		return errors.New(ERR_221)
	case "222":
		return errors.New(ERR_222)
	case "223":
		return errors.New(ERR_223)
	case "224":
		return errors.New(ERR_224)
	case "225":
		return errors.New(ERR_225)
	case "226":
		return errors.New(ERR_226)
	case "227":
		return errors.New(ERR_227)
	case "CME":
		return errors.New(ERR_CME)
	default:
		return errors.New(ERR_UNKNOWN)
	}
}
